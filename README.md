...
4. Can I use a custom search provider for random searches?
...
5. What is the 'Logging level' preference for?
...
6. What is the 'Locale(s)' preference for?
...
7. I've set my preferred Locale but I still occasionally get pages in other languages - why?
...
8. Some pages have background sound tracks or auto-running videos - can I turn these off?
  * These background media are built into the web page and at present the add-on has no means to suppress such content.
9. Is there anything I should be wary of when using this add-on?
